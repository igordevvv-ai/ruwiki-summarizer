...
def build_intro_prompts(intro_text: str, min_sent: int, max_sent: int) -> Tuple[str, str]:
    ...
    system_prompt = (
        ...
        "для школьника 9–11 класса. "
        "Сохраняй нейтральный, энциклопедический стиль, как в статьях ЕГЭ/ОГЭ. "
    ...
    user_prompt = (
        ...
        f"Перепиши его для школьника 9–11 класса, сохранив смысл, но упростив формулировки.\n"
...
def build_section_prompts(
    ...
    system_prompt = (
        "Ты — редактор Рувики. "
        "Твоя задача — переписать раздел статьи простым и понятным русским языком для школьника 9–11 класса. "
        "Сохраняй нейтральный, энциклопедический стиль, как в статьях ЕГЭ/ОГЭ. "
        "Не используй обращения к читателю и местоимения 'я', 'ты', 'вы'. "
    ...
    user_prompt = (
        ...
        "Перепиши этот раздел для школьника 9–11 класса, сохранив только ключевые факты и смысл.\n"
        f"Сделай строго не меньше {min_sent} и не больше {max_sent} предложений."
